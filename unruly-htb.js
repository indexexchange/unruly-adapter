...
var PartnerSpecificValidator = require('unruly-htb-validator.js');
...
function UnrulyHtb(configs) {
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'UnrulyHtb', // PartnerName
            namespace: 'UnrulyHtb', // Should be same as partnerName
            statsId: 'UNRLY', // Three character unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
